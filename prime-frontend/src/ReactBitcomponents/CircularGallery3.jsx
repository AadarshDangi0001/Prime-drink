...
export default function CircularGallery3({
  items,
  bend = 3,
  textColor = "#ffffff",
  borderRadius = 0.05,
  ...
  useEffect(() => {
      ...
      if (app.medias) {
        for (let media of app.medias) {
          ...
          if (
            ...
            sessionStorage.setItem('gallery3Scroll', app.scroll.current);
    ...
    const savedScroll = sessionStorage.getItem('gallery3Scroll');
    if (savedScroll !== null) {
      app.scroll.current = parseFloat(savedScroll);
      app.scroll.target = parseFloat(savedScroll);
      sessionStorage.removeItem('gallery3Scroll');
    }
